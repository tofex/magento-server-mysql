...
mysql "-h${databaseHost}" "-P${databasePort:-3306}" "-u${databaseUser}" --binary-mode --default-character-set=utf8 --init-command="SET SESSION FOREIGN_KEY_CHECKS=0;" "${databaseName}" < "${tempDir}/import.sql"
